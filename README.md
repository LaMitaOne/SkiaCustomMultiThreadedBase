...
On Asus zenbook ux305ca dual core no artifacts(rarely saw some later) even at 64 threads, but getting a bit slow 17fps, still nice to test. Runs stable few minutes till mem full at 64 threads. Ok same time hd video & Firefox open is maybe bit much too :D But Artifacts think probably a timing problem at faster pc, at our gate       
